          ...
          <form action="{{ route('snimiKorisnika', ['korisnik' => $korisnik->id]) }}" method="post">
            ...
            <form action="{{ route('dodajKorisnika') }}" method="post">
              ...
              <div class="form-group row">
                ...
                <div class="col-md-6 m-2">
                  <input id="ime" type="text" class="form-control @error('ime') is-invalid @enderror" name="ime"
                    required value="{{ $korisnik->ime ?? old('ime') }}" autocomplete="ime" autofocus>
                  @error('ime')
              ...
              <div class="form-group row">
                ...
                <div class="col-md-6 m-2">
                  <input id="prezime" type="text" class="form-control @error('prezime') is-invalid @enderror"
                    name="prezime" required value="{{ $korisnik->prezime ?? old('prezime') }}" autocomplete="prezime"
                    autofocus>
              ...
              <div class="form-group row">
                ...
                <div class="col-md-6 m-2">
                  <input id="telefon" type="text" class="form-control @error('telefon') is-invalid @enderror"
                    name="telefon" required value="{{ $korisnik->telefon ?? old('telefon') }}" autocomplete="telefon"
                    autofocus>
              ...
              <div class="form-group row">
                ...
                <div class="col-md-6 m-2">
                  <input id="username" type="text" class="form-control @error('username') is-invalid @enderror"
                    name="username" value="{{ $korisnik->username ?? old('username') }}" required
              ...
              <div class="form-group row mb-2">
                <div class="col-md-8 offset-md-2">
                  <a href="/admin/svikorisnici" class="btn btn-outline-secondary float-left">
                    OTKAŽI
                  </a>
