  ...
  <div class="container-fluid">
    ...
    <div>
      <div class="card mb-3">
              ...
              <form action="/sestra/pretragaPacijenata" method="get">
                <div class="row justify-content-between">
                  ...
                  <div class="input-group col-md-3">
                    ...
                    <input type="text" name="str" class="form-control" placeholder="Pretraga pacijenata" value="{{ $_GET['str'] ?? '' }}">
            ...
            <table class="table table-striped" id="dataTable" width="100%" cellspacing="0">
              ...
              <tbody>
                ...
                <tr>
                  ...
                  <td>{{ $pacijent->lbo }}</td>
                  <td><a href="izmenipacijenta/{{ $pacijent->id }}" class="btn btn-primary" title="Izmeni pacijenta">Izmeni</a></td>
        ...
        <div class="row justify-content-between">
          <a href="/sestra/dodajPacijenta" class=" btn btn-primary m-1 ml-4" title="Dodaj novog korisnika">Dodaj
            pacijenta</a href="">
