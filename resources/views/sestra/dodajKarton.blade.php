  ...
  <div class="row justify-content-center">
    <div class="col-md-8">
      <div class="card">
        ...
        <div class="card-body">
          @if (isset($pacijent->karton->broj_kartona))
          <form action="{{ route('izmeniKarton', ['pacijent' => $pacijent->id]) }}" method="post">
          {{-- <form action="{{ route('snimiKarton', ['pacijent' => $pacijent->id]) }}" method="post"> --}}
            @method('PUT')
            @else
            <form method="POST" action="{{ route('dodajKarton', ['pacijent' => $pacijent->id]) }}">
              @endif
              @csrf
              ...
              <div class="form-group row mb-2 dugme">
                <div class="col-md-8 offset-md-2">
                  <a href="/sestra/kartoni" class="btn btn-outline-secondary float-left">
                    OTKAŽI
                  </a>
