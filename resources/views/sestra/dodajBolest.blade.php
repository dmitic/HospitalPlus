  ...
  <div class="row justify-content-center">
    <div class="col-md-8">
      <div class="card">
        ...
        <div class="card-body">
          @if (isset($bolest->id))
          <form action="{{ route('snimiBolest', ['bolest' => $bolest->id]) }}" method="post">
            @method('PUT')
            @else
            <form method="POST" action="{{ route('dodajBolest') }}">
              @endif
              {{-- <form method="POST" action="{{ route('dodajBolest') }}"> --}}
              @csrf
              ...
              <div class="form-group row mb-2">
                <div class="col-md-8 offset-md-2">
                    <a href="/sestra/bolesti" class="btn btn-outline-secondary float-left">
                      OTKAŽI
                    </a>
